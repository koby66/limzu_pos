...
class language
{
	...
	var $adminHomeWelcomeMessage='Point of Sale system.&nbsp;You are currently logged in<br>as an administrator.<br> With administrative rights, you can go anywhere and do anything on this system.&nbsp;<br>Alternatively, you may select from the following com
