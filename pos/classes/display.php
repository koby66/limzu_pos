	...
	function display($connection,$theme,$currency_symbol,$language)
	{
		...
		switch($theme)
		{
			case $theme=='big blue':
				...
				$this->border_width='1';
				$this->border_color='#b90404';
				
				$this->header_rowcolor='#b90404';
				$this->header_text_color='white';
				$this->headerfont_face='arial';
				$this->headerfont_size='2';

				
				$this->rowcolor1='#7f7d7d';
				$this->rowcolor2='#cecece';
				$this->rowcolor_text='#000000';
				$this->rowfont_face='geneva';
				$this->rowcolor_link='#000000';
				$this->rowfont_size='2';
				$this->sale_bg='#b90404';
